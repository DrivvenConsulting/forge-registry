Run full story delivery: end-to-end from parent issue in Todo to refined sub-issues, implementation, QA, and optional integration test.

Run the workflow with id **full-story-delivery**.

Follow the execution policy:

1. **Plan mode first:** Read the workflow definition from `.cursor/workflows/full-story-delivery/WORKFLOW.md`. Present the plan (steps and inputs from that file). Do not execute any step until I confirm the plan.
