Run backlog-to-ready: refine Backlog issue with tech-lead and specialists, then move to Ready.

Run the workflow with id **backlog-to-ready**.

Follow the execution policy:

1. **Plan mode first:** Read the workflow definition from `.cursor/workflows/backlog-to-ready/WORKFLOW.md`. Present the plan (steps and inputs from that file). Do not execute any step until I confirm the plan.
