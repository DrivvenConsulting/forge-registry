...
- **When implementing APIs, you must use the api-implementation skill** (satisfied by **backend-task-breakdown** and project rules: framework-fastapi, architecture-decoupling).
