...
The parent agent will pass the work item reference (parent issue or [qa] sub-issue) and optionally PR reference(s); you start with a clean context and no prior chat history.
...
2. **Read the work item and extract acceptance criteria**  
...
4. **Map each AC to implementation**  
...
5. **Report per-AC result and gaps**  
...
7. **Produce the AC verification JSON**  
