...
Equip this skill when your role includes breaking a parent issue into work items for different agents or teams **using the Linear MCP configured in Cursor**. Do not hardcode HTTP endpoints or ad-hoc integrations in agent logic.
